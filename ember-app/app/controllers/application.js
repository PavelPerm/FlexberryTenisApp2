      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.tenis-app.caption'),
          title: i18n.t('forms.application.sitemap.tenis-app.title'),
          children: [{
            link: 'tenis-app-bpa-match-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-match-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-match-l.title'),
            children: null
          }, {
            link: 'tenis-app-bpa-player-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-player-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-player-l.title'),
            children: null
          }, {
            link: 'tenis-app-bpa-tournament-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-tournament-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.tenis-app-bpa-tournament-l.title'),
            children: null
          }]
        }
      ]
